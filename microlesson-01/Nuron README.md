...
1. **Input:**
   - Receives inputs Inputs: x1, x2, ..., xn, which could be raw data, features, or outputs from neurons in the previous layer.
   - Each input is associated with a weight Weights: w1, w2, ..., wn, indicating the importance of the input.
