...
1. **Create a Directory**
   - On your machine, create a directory or folder named `intro-to-neural-networks-overview-of-ai-architectures` where you can save all the data and the jupyter notebooks concerned with this module.
...
4. **Create a New Jupyter Notebook**  
   ...
   - Rename the notebook by clicking on the **default name ("Untitled")** and entering the name as:  
     ```
     <INTRO_TO_NEURAL_NETWORKS_OVERVIEW_OF_AI_ARCHITECTURES>.ipynb
     ```
